...
projectname="northwind_api_logic"  # lower case, only
resourcegroup="northwind1apilogic_rg"
dockerrepositoryname="thomasgpeters"  # change this to your DockerHub Repository
githubaccount="thomasgpeters"         # change this to your GitHub account
version="1.0.0"
...
# git clone https://github.com/apilogicserver/northwind1apilogic.git
# cd northwind1apilogic
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name northwind1apilogic --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
